...
def CLICommands(props):
    return psx(f"""
        <section id="cli-commands" class="mt-8 space-y-6">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="p-4 bg-gray-900 border border-gray-700 rounded-2xl">
            ...
            <div class="p-6 bg-gray-800 border border-gray-700 rounded-2xl">
                ...
                <pre class="p-4 mt-4 overflow-x-auto text-sm rounded-lg bg-gray-950 text-emerald-400">nextpy dev --port 3000      # Custom port
...
nextpy dev --no-reload      # Disable auto-reload</pre>
            ...
            <div class="p-6 bg-gray-800 border border-gray-700 rounded-2xl">
                ...
                <pre class="p-4 mt-4 overflow-x-auto text-sm rounded-lg bg-gray-950 text-emerald-400">nextpy ai chatbot           # Start AI chat interface
