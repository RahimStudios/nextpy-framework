...
```python
from nextpy import useSate, create_onclick // and all utitlities
from brn import Button
@component
def Home(props=None):
    [name, setName]=usestate('rahim') // and all hooks
    ...
    return (
        <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-purple-600">
            ...
            <Button crate_onclick=()/>
            {for this in thisss}
            {if me in name} //actually all python logic should work
        </div>
    )
